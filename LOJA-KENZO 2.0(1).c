...
int main(){
    ...
    while(1){
        ...
        if(opt1 == 1){ // Opção: sim
            ...
            while(1){
                printf("\n\n");
                printf("1 - Queijo 1\t R$ 20,00\n");
                printf("2 - Leite 2\t R$ 12,00\n");
                printf("3 - Pao 3\t R$ 3,00\n");
                printf("4 - Macarrao 4\t R$ 14,00\n");
                printf("5 - Suco de uva 5\t R$ 15,00\n");
                printf("6 - Abobrinha 6\t R$ 16,00\n");
                printf("7 - Nescau 7\t R$ 17,00\n");
